<template>
    <nav class="watch-navigation"
        ...
        <router-link v-ripple class="watch-navigation__link" active-class="watch-navigation__link--active"
            :class="{'watch-navigation__link--active': $route.path.startsWith('/timeshift')}"
            v-ftooltip.right="'タイムシフト'" to="/timeshift/">
            <Icon class="watch-navigation__link-icon" icon="fluent:rewind-20-regular" width="26px" />
        </router-link>
        <router-link v-ripple class="watch-navigation__link" active-class="watch-navigation__link--active"
